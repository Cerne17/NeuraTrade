...
\input{sections/01_desbalanceamento}
\input{sections/02_arquitetura}
\input{sections/03_validacao}
\input{sections/04_multiplas_redes}
\input{sections/05_sintese}
\input{sections/06_fase2}
\input{sections/07_conditional_macro}
\input{sections/08_avaliacao_ideias}
