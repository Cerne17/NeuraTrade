...
$\pm$~desvio do erro por candidato. Rodado (notebook \texttt{08}, com $10$ folds --- a convenção
de Kohavi, 1995) para \texttt{latent\_dim} $\in \{8,16,32\}$, os três praticamente empataram
(\texttt{val\_loss} $\approx 0{,}0154$): o gargalo \textbf{16 foi confirmado} e, de quebra, o
modelo mostrou-se \emph{insensível} ao tamanho do gargalo nessa faixa --- um sinal de robustez.
Decisão em ADR-0010.
\end{naprat}
