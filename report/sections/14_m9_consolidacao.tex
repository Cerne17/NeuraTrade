...
(\texttt{walk\_forward\_splits\_multivariate}) e com $\texttt{n\_splits}=10$ (Kohavi, 1995),
avaliou o gargalo do modelo Close+Volume: \texttt{val\_loss} médio $0{,}016485$ ($8$),
$0{,}016416$ ($16$), $0{,}016311$ ($32$) --- de novo \textbf{insensível} (amplitude
$\approx 0{,}0002$). Um detalhe revela o ponto: o ``melhor'' \texttt{latent\_dim} \emph{mudou} de
$8$ (sob $5$ folds) para $32$ (sob $10$ folds) --- precisamente porque os três estão dentro do
ruído, o argmin é instável e não carrega significado. Mantém-se $16$ por consistência com o
univariado. A insensibilidade do gargalo, observada em ambas as representações e em dois desenhos
de validação, é evidência robusta.
